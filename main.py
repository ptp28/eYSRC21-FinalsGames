...
def game_first():
    ...
    def Instruction():
        ...
        image_widget = menu1.add.image(image_path='Logo_of_first_game.gif')
        # image_widget.set_border(1, 'black')
        image_widget.set_float(origin_position=True)
        image_widget.scale(1.3, 1.3)
        image_widget.translate(-5, 15)
        image_widget = menu2.add.image(image_path='eyan_logo.gif')
        # image_widget.set_border(1, 'black')
        image_widget.set_float(origin_position=True)
        image_widget.scale(0.80, 0.80)
        image_widget.translate(490, 0)
        image_widget = menu2.add.image(image_path='robo.gif')
        # image_widget.set_border(1, 'black')
        image_widget.set_float(origin_position=True)
    ...
    image_widget.scale(1.3,1.3)
    image_widget.translate(-5, 15)
    image_widget = menu1.add.image(image_path='eyan_logo.gif')

    image_widget.set_float(origin_position=True)
    image_widget.scale(0.80, 0.80)
    image_widget.translate(480, 0)
    image_widget = menu1.add.image(image_path='robo.gif')
...
def game_second():
    ...
    def Instruction():
        ...
        menu2.add.button('Video Instruction', demo)
        menu2.add.button('back', back1)
        image_widget = menu2.add.image(image_path='space_invader.gif')
    ...
    menu1.add.button('Instruction', Instruction)
    menu1.add.button('back',back)
    image_widget = menu1.add.image(image_path='space_invader.gif')
    # image_widget.set_border(1, 'black')
    image_widget.set_float(origin_position=True)
    image_widget.scale(0.80, 0.80)
    image_widget.translate(-30, 255)
...
def game_third():
    ...
    def Instruction():
        ...
        menu2.add.button('Video Instruction', demo)
        menu2.add.button('back', back1)
        image_widget = menu2.add.image(image_path='space_invader 2.gif')
    ...
    menu1.add.button('Instruction', Instruction)
    menu1.add.button('back',back)
    image_widget = menu1.add.image(image_path='space_invader 2.gif')
...
def game_fourth():
    ...
    def Instruction():
        ...
        menu2.add.button('Video Instruction', demo)
        menu2.add.button('back', back1)
        image_widget = menu2.add.image(image_path='ball_finder.gif')
        # image_widget.set_border(1, 'black')
        image_widget.set_float(origin_position=True)
        image_widget.scale(0.80, 0.80)
        image_widget.translate(-30, 255)
    ...
    menu1.add.button('Instruction', Instruction)
    menu1.add.button('back',back)
    image_widget = menu1.add.image(image_path='ball_finder.gif')
...
image_widget = menu.add.image(image_path='eyan_logo.gif')

image_widget.set_float(origin_position=True)
image_widget.scale(0.80, 0.80)
image_widget.translate(480, 0)
image_widget = menu.add.image(image_path='robo.gif')
